...
namespace HandleBoi.Cheat
{
    class GameDataParser
    {
        ...
        private readonly Dictionary<string, string> dropGNameMap = new Dictionary<string, string>
        {
            ...
            { "Item_Heal_MedKit", "Meds" }, { "Item_Heal_FirstAid", "Meds" },
            { "Item_Weapon_Kar98k", "kar98" }, { "Item_Weapon_Mini14", "mini" },
            { "Item_Weapon_M16A4", "M16" }, { "Item_Weapon_HK416", "m416" },
            { "Item_Weapon_SCAR-L", "SCAR" }, { "Item_Weapon_SKS", "sks" },
